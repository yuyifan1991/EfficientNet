...
def divideTrainTest(source_path, train_path, test_path):
 ...
 #   mkClassDir(source_path,validation_path)
    ...
    for i in range(0, classes_num):
        ...
        test_image_list = source_image_dir[int(0.8 * len(source_image_dir)):int(len(source_image_dir))]
        #test_image_list = source_image_dir[int(0.2*len(source_image_dir)):]
        """
...
if __name__=='__main__':
    data_path = 'home_data/'
    source_path = 'home/'
    train_path = 'home_data/train/'
    test_path = 'home_data/test/'
    mkTotalDir(data_path)
    divideTrainTest(source_path, train_path, test_path)
